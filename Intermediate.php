  ...
  <div class="container-fluid">
    <div class="row">
      <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
        <div class="sidebar-sticky pt-3">
          ...
          <ul class="nav flex-column mb-2">
            ...
            <li class="nav-item">
              <a class="nav-link active" href="Intermediate.php">
                <span data-feather="file-text"></span>
                Intermediate <span class="sr-only">(current)</span>
              </a>
            </li>
            <li class="nav-item">
      ...
      <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
        ...
        <div class="frm">
          <h6>A little information about your Intermediate.</h6>
        </div>
        <div class="frm">
          <form class="needs-validation" novalidate>
            ...
            <div class="form-row">
              ...
              <div class="col-md-6 mb-3">
                ...
                <textarea class="form-control" id="validationTextarea" placeholder="Physics, Chemistry, English, ..." required></textarea>
                <div class="invalid-feedback">
            ...
            <div class="form-row">
              <div class="input-group col-md-6 mb-3">
                <div class="custom-file">
                  ...
                  <label class="custom-file-label" for="inputGroupFile04">Upload your Intermediate / Class 12th marksheet here</label>
                </div>
              </div>
            </div>
