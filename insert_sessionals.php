...
<?php
  ...
  $sessional = isset($_POST['sessional']) ? $_POST['sessional'] : '';
  $subject = isset($_POST['subject']) ? $_POST['subject'] : '';
  $obt_marks = isset($_POST['obt_marks']) ? $_POST['obt_marks'] : '';
  $tot_marks = isset($_POST['tot_marks']) ? $_POST['tot_marks'] : '';
  $faculty = isset($_POST['faculty']) ? $_POST['faculty'] : '';
  $semester = 'sem'.$semester;
  $sessional = 'marks_obt_s'.$sessional;
  $subject = strtoupper($subject);

if(!empty(isset($semester)) || !empty(isset($sessional)) || !empty(isset($subject)) || !empty(isset($obt_marks)) || !empty(isset($tot_marks)) || !empty(isset($faculty))){
    ...
    if(mysqli_connect_error()){
      ...
      while($row = mysqli_fetch_array($result)){
        ...
        if($subjectpresent == false){
          $sql = "INSERT INTO $semester(subject, $sessional, marks_tot, faculty) VALUES ('$subject', $obt_marks, $tot_marks, '$faculty')";
        if($conn->query($sql)){
  ...
  <div class="card text-center">
    ...
    <div class="card-body">
      <h5 class="card-title">
        ...
        echo $result_ins;
        ?></h5>
      <a href="Admin_Sessionals_insert.html" class="btn btn-dark btn-sm">Back</a>
