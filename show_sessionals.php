          ...
          <div class="table-responsive">
            <table class="table table-hover">
              ...
              <?php
                ...
                if(!empty(isset($semester)) || !empty(isset($sessional))){
           ...
           <a class="btn btn-outline-dark" href="Sessionals.php" role="button">Back</a>
           <a class="btn btn-outline-primary" href="Admin_Sessionals.php" role="button" style="float: right;">Go to sessionals</a>
           <br>
