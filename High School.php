  ...
  <div class="container-fluid">
    <div class="row">
      <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
        <div class="sidebar-sticky pt-3">
          ...
          <ul class="nav flex-column mb-2">
            ...
            <li class="nav-item">
              <a class="nav-link active" href="High School.php">
                <span data-feather="file-text"></span>
                High School <span class="sr-only">(current)</span>
              </a>
            </li>
          </ul>
        </div>
      ...
      <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
        ...
        <div class="frm">
          <h6>A little information about your High School.</h6>
        </div>
        <div class="container">
          <div class="row">
            <div class="col">
          <form class="needs-validation" novalidate>
            <div class="form-row">
              <div class="col-md-6 mb-3">
                ...
                <input type="text" class="form-control" id="validationCustom01" placeholder="Sanyam" required>
              ...
              <div class="col-md-6 mb-3">
                ...
                <input type="text" class="form-control" id="validationCustom02" placeholder="Srivastava" required>
                <div class="valid-feedback">
                  Looks good!
                </div>
              </div>
            ...
            <div class="form-row">
              <div class="col-md-6 mb-3">
                <label for="validationCustom05">Name of School</label>
              ...
              <div class="col-md-6 mb-3">
                <label for="validationCustom06">Affiliation</label>
            ...
            <div class="form-row">
              <div class="col-md-6 mb-3">
                <label for="validationCustom010">Overall score</label>
                <input type="text" class="form-control" id="place" placeholder="Enter percentage" required>
                <div class="custom-control custom-checkbox custom-control-inline" style="margin-top: 10px;">
                  <input type="checkbox" class="custom-control-input" id="customCheck1" onchange="textChanger(this)">
                  <label class="custom-control-label" for="customCheck1">CGPA</label>
                </div>
                <div class="valid-feedback">
                  Looks good!
                </div>
              ...
              <div class="col-md-6 mb-3">
                <label for="validationTextarea">Enter your subjects</label>
                <textarea class="form-control" id="validationTextarea" placeholder="English, Mathematics, Science, ..." required></textarea>
                <div class="invalid-feedback">
            ...
            <div class="form-row">
              <div class="input-group col-md-6 mb-3">
                <div class="custom-file">
                  ...
                  <label class="custom-file-label" for="inputGroupFile04">Upload your High School / Class 10th marksheet here</label>
                </div>
              </div>
            </div>
