...
<div class="frm">
  <div class="card mb-3" style="max-width: 1100px;">
    <div class="row no-gutters">
      <div class="col-md-4">
        <img src="Snips/Home Page.png" class="card-img" alt="Image here">
      </div>
      <div class="col-md-8">
        <div class="card-body">
          ...
          <div class="form-row">
            <div class="col-md-6 input-group-sm mb-3">
              <label for="validationCustom03">Father's name</label>
              <input type="text" class="form-control" id="able" required>
              <div class="valid-feedback">
                Looks good!
              </div>
            </div>
            <div class="col-md-6 input-group-sm mb-3">
              <label for="validationCustom04">Mother's name</label>
              <input type="text" class="form-control" id="able" required>
              <div class="valid-feedback">
                Looks good!
              </div>
          ...
          <div class="form-row">
            <div class="col-md-6 input-group-sm mb-3">
              <label for="validationCustom01">College ID</label>
              <input type="text" class="form-control" id="validationCustom01" placeholder="71100312" required>
              <div class="valid-feedback">
                Looks good!
              </div>
            </div>
            <div class="col-md-6 input-group-sm mb-3">
              <label for="validationCustom02">University Roll Number</label>
              <input type="text" class="form-control" id="validationCustom02" placeholder="6321627700" required>
              <div class="valid-feedback">
                Looks good!
              </div>
            </div>
          ...
          <div class="form-row">
            <div class="col-md-6 input-group-sm mb-3">
              <label for="validationCustom01">Course</label>
          ...
          <div class="form-row">
            ...
            <div class="col-md-6 input-group-sm mb-3">
              <label for="validationCustom02">Year / Semester</label>
              <input type="text" class="form-control" id="validationCustom02" required>
              <div class="valid-feedback">
                Looks good!
              </div>
...
function textChanger(checkBox){
  if(checkbox.checked){
    var placeVar = 'Enter percentage';
  }
  else {
    var placeVar = 'Enter CGPA';
  }
}
</script>
